...
@Component({
  selector: 'CustomerServiceTicket-home',
  templateUrl: './CustomerServiceTicket-home.component.html',
  styleUrls: ['./CustomerServiceTicket-home.component.scss']
})
export class CustomerServiceTicketHomeComponent implements AfterViewInit {
