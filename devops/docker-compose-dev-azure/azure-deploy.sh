...
resourcename="crm1"  # lower case, only
resourcegroup="crm1_rg"
...
# git clone https://github.com/apilogicserver/crm1.git
# cd crm1
...
az group create --name crm1_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crm1_rg --sku S1 --is-linux
az container create --resource-group crm1_rg --name crm1 --image apilogicserver/crm1:latest --dns-name-label crm1 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crm1.westus.azurecontainer.io:5656'
